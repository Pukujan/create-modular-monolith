...
Append a **planning-only** study log entry under `work-log/planning/`.
...
4. **Filename** — `work-log/planning/{NNN}_{YYYY-MM-DD}_{HH-MM}_study-log_{slug}.md` using UTC from `formatWorkLogTimestamp` in `backend/src/shared/utils/formatExchangeTimestamp.js`.
