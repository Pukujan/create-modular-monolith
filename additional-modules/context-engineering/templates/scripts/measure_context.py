...
Usage:
    ...
    python scripts/measure_context.py --status
    python scripts/measure_context.py --tokens 0 --start-session
...
def main() -> int:
    ...
    if usage >= HARD_LIMIT:
        ...
        print("   Run: python scripts/measure_context.py --archive-session --slug <topic> --tokens <count>", file=sys.stderr)
